...
@ApiModel(description= "RTU信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class RtuDto {
    @ApiModelProperty(value = "rtu的id")
    ...
    @ApiModelProperty(value = "硬件版本 默认填1")
    @Range(min = 1, max = 1, groups = {CreatMethod.class, UpdateMethod.class})
    @NotNull(groups = {CreatMethod.class})
    ...
    @ApiModelProperty(value = "使用类型 1:路灯 2:光彩")
    @NotNull(groups = {CreatMethod.class})
